...
const Profil = () => {
  ...
  return (
    ...
    <Layout>
        ...
        {isUpdated && <Alert variant="success">Profil mis à jour avec succès !</Alert>}
        {errorMessage && <Alert variant="danger">{errorMessage}</Alert>}

        <Row className='g-3 mt-4'>
            <Col md={4} className="d-flex justify-content-center bg-dark text-white rounded ">
            <div className='shadow p-3  h-100 d-flex flex-column align-items-center justify-content-center'>
                {imagePreview ? (
                    <Image src={imagePreview} roundedCircle width={150} height={150} />
                ) : (
                    <Image
                    src={userData?.profileImage ?  userData?.profileImage : "https://via.placeholder.com/150"}
                    roundedCircle
                    width={150}
                    height={150}
                    />
            ...
            <Col md={8}>
            <Form onSubmit={handleSubmit} className='text-start shadow p-4 bg-dark text-white rounded'>
                ...
                <Row className="mb-3 ">
                    <div className='d-flex justify-content-center'>
                        <Button variant="primary" type="submit" className='validateBtn'>
